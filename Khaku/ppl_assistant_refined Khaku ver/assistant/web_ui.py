...
<body class="dark-mode">
    <div class="container">
        ...
        <div class="quick-actions" id="quick-actions">
            <div class="quick-example">Show calendar + dd/mm/yyyy</div>
            <div class="quick-example">Show meeting + dd/mm/yyyy</div>
            <div class="quick-example">Show event + dd/mm/yyyy</div>
            <div class="quick-example">Show weather + city name + dd/mm/yyyy</div>
            <div class="quick-example">Set reminder + hh:mm + dd/mm/yyyy</div>
            <div class="quick-example">Set meeting + hh:mm + dd/mm/yyyy</div>
            <div class="quick-example">About "your Title", remember to add ""</div>
